...
The project includes a React frontend in `frontend/`.

### Run frontend locally

1. Start backend app first (port `8080`).
2. In a new terminal:
   ```bash
   cd frontend
   npm install
...
- `VITE_API_BASE_URL`
  - Default: `http://localhost:8080/api/v1/leaderboard`
...
- Import collection: `backend/postman/Real-Time-Leaderboard.postman_collection.json`
...
- `backend/target/realtime-leaderboard-system-1.0.0.jar`
